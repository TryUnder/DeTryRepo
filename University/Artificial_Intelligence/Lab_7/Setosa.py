...
history = model.fit(x_train, y_train, batch_size = 1, epochs=20 , verbose=0)
...
#optymalna ilość to po 3/4 neurony dla każdej warstwy ukrytej i 30/20 epok 